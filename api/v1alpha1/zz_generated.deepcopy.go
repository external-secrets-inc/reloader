...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkflowDestination) DeepCopyInto(out *WorkflowDestination) {
	*out = *in
	if in.NamespaceSelectors != nil {
		in, out := &in.NamespaceSelectors, &out.NamespaceSelectors
		*out = make([]v1.LabelSelector, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkflowDestination.
func (in *WorkflowDestination) DeepCopy() *WorkflowDestination {
	if in == nil {
		return nil
	}
	out := new(WorkflowDestination)
